...
for i=1:NumberOfDevices
    ...
    if pop(i).battreyLevel < 15 && pop(i).Technology>1
        pop(i).EnergyConsumptionPerBit = Technologies(pop(i).Technology-1).min + (Technologies(pop(i).Technology-1).max- Technologies(pop(i).Technology-1).min)*rand;
    else
